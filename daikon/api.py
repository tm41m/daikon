...
product_listings = [
    ProductListing(1, 'White Onion', 1, 1, 1.69,
                   'lbs', 'CAD', 1, True, True, 1, now_iso, now_iso),
    ProductListing(2, 'White Onion', 1, 2, 2.69,
                   'lbs', 'CAD', 1, True, True, 1, now_iso, now_iso)
]
...
def get(id):
    ...
    product_listing = product_listings_schema.dump(
        filter(lambda t: t.id == id, product_listings)
    )
