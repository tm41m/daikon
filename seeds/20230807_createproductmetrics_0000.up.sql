...
INSERT INTO wolfram.product_timeseries_metrics VALUES
    ...
    ('2023-01-01', 'ON', null, 1, 'CAD', '/ 1kg', 6.00, 0.01, 110, 98, md5('2023-01-01' || '1' || 'ON' || '')),
    ('2023-01-02', 'ON', null, 1, 'CAD', '/ 1kg', 6.01, 0.01, 111, 98, md5('2023-01-02' || '1' || 'ON' || '')),
    ('2023-01-01', null, null, 1, 'CAD', '/ 1kg', 6.05, 0.01, 120, 98, md5('2023-01-01' || '1' || '' || '')),
    ('2023-01-02', null, null, 1, 'CAD', '/ 1kg', 6.06, 0.01, 121, 98, md5('2023-01-02' || '1' || '' || ''));
